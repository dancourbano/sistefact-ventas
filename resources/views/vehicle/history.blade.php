...
@section('content')
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">Historial Vehiculos Retirados</h3>
        </div>
        <div class="panel-footer">
            <div class="btn-toolbar" role="toolbar">
                <div class="row pull-right">
                    <br>
                    <div class="col-sm-12">
                        <a class="btn btn-success" href="{{ URL::action('VehicleController@showVehicle',['create',0]) }}" >Agregar Nuevo Vehiculo </a>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-9 col-sm-offset-1">
                                            <table class="table invoice-items text-dark">
                                                ...
                                                <tr class="b-top-none">
                                                    <td id="cell-id">Nombre:</td>
                                                    <td id="cell-desc" class="text-left"><span id="spanNombreEmergencia"></span></td>
                                                </tr>
                                                <tr>
                                                    <td id="cell-id">Telefono:</td>
                                                    <td id="cell-desc" class="text-left"><span id="SpanTelefonoEmergencia"></span></td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        </div>
            ...
            $.ajax({
                ...
                success : function(data) {
                    ...
                    if(data!={}){
                        ...
                        $('#SpanTelefonoEmergencia').text(data['vehicle'][0].personTelEmergency);
                        $('#SpanTelefonoEmergencia').text(data['vehicle'][0].telEmergency);
                    }
