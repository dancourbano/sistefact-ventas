        ...
        <div class="panel-body">
            ...
            <div class="btn-toolbar" role="toolbar">
                <div class="row pull-right">
                    <div class="col-sm-6">
                        <a class="btn btn-success btn-sm" href="{{ URL::action('ProductController@showHistory') }}" >
                            Ver historial Productos
                        </a>
                    </div>
                    <div class=" col-sm-6">
                    ...
                    @foreach ($products as $product)
                        <tr>
                            ...
                            <td class="text-center">
                                <div>
                                    <button class="btn btn-info btn-sm" onclick="editProduct({{$product->itemId}})"><i class="fa fa-pencil"></i></button>
